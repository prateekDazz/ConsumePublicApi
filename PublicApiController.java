...
public class PublicApiController {
	...
	private static String API = "https://api.weatherstack.com/current?access_key=****&query=test";
	...
	public WeatherResponseDto getWeather(@RequestParam("city") String city) {
		...
		// ResponseEntity<WeatherResponseDto> weatherResponseDto=
		// restTemplate.exchange(apiRequest, HttpMethod.GET, entity,
		// WeatherResponseDto.class);
		ResponseEntity<WeatherResponseDto> WeatherResponseDto = restTemplate.exchange(apiRequest, HttpMethod.GET, null,
				WeatherResponseDto.class);
